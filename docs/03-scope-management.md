...
**Issue:** Site selection was the solar advocates' responsibility, not the student team's, per Kelly Electric's own earlier clarification.
...
On a multi-stakeholder project, scope doesn't stay fixed just because it was defined once. It has to be actively watched and re-asserted as the project moves and as different stakeholders make requests. Catching scope drift early kept the team from spending limited time on work that wasn't going to count toward our deliverable.
